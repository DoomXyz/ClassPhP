...
<div class="container my-5">
    <div class="row justify-content-center">
        <div class="col-12 col-md-8">
            ...
            <form method="POST" action="/webbanhang/Category/update" class="p-4 rounded shadow-sm"
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" class="form-control"
                        style="background: rgb(70, 60, 100); border-color: rgb(138, 74, 243); color: rgb(200, 200, 220); min-height: 120px;"><?php echo htmlspecialchars($category->description ?? '', ENT_QUOTES, 'UTF-8'); ?></textarea>
                </div>
